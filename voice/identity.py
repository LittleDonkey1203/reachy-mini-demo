...
_YUNET_PATH = os.path.join(_DIR, "models", "face_detection_yunet_2023mar.onnx")
_ARCFACE_PATH = os.path.join(_DIR, "models", "w600k_mbf.onnx")
_DB_PATH = os.path.join(_DIR, "face_db.json")
